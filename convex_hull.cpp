...
// function to check whether the line is crossing the polygon
int
orientation (pair < int, int >a, pair < int, int >b, pair < int, int >c)
{
...
bool
compare (pair < int, int >p1, pair < int, int >q1)
{
...
vector < pair < int, int >>
merger (vector < pair < int, int > >a, vector < pair < int, int > >b)
{
...
// We use brute algorithm to find convex hull if number of points is less than 6.
  if (a.size () <= 5) {
    return bruteHull (a);
  }
